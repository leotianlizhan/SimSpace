...
{
    public partial class PlanetJackForm : Form
    {
        /// <summary>
        ...
        public PlanetJackForm(string filePath)
            : this()
        {
            //load all the data
        ...
        //Tianli
        private void PlanetJackForm_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        //Tianli
        private void PlanetJackForm_MouseUp(object sender, MouseEventArgs e)
        {
        ...
        private void PlanetJackForm_MouseClick(object sender, MouseEventArgs e)
        {
