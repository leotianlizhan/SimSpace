...
{
    public partial class PlanetAndrewForm : Form
    {
        /// <summary>
        ...
        public PlanetAndrewForm(string filePath)
            : this()
        {
            //load all the data
        ...
        //Tianli
        private void PlanetAndrewForm_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        //Tianli
        private void PlanetAndrewForm_MouseUp(object sender, MouseEventArgs e)
        {
        ...
        private void PlanetAndrewForm_MouseClick(object sender, MouseEventArgs e)
        {
